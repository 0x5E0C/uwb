...
KalmanInfo ADistance,BDistance,CDistance,DDistance;

void KalMan_Total_Init()
{
	Init_KalmanInfo(&ADistance,3,10);
	Init_KalmanInfo(&BDistance,3,10);
	Init_KalmanInfo(&CDistance,3,10);
	Init_KalmanInfo(&DDistance,3,10);
}
